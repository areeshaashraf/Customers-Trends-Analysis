...
-- Q5. Do subscribed customers spend more? Avg spend and total revenue by subscription status
...
-- Q6. 5 products with highest % of purchases with discounts
...
-- NOTE: Don’t have an age_group column, so let's create it using CASE
SELECT CASE 
